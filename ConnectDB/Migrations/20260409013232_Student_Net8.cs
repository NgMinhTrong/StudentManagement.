...
{
    /// <inheritdoc />
    public partial class Student_Net8 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<int>(type: "int", nullable: false),
                    Semester = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    Score15Min = table.Column<float>(type: "real", nullable: true),
                    Score45Min = table.Column<float>(type: "real", nullable: true),
                    ScoreFinal = table.Column<float>(type: "real", nullable: true),
                    AverageScore = table.Column<float>(type: "real", nullable: true, computedColumnSql: "(ISNULL(Score15Min,0) + ISNULL(Score45Min,0)*2 + ISNULL(ScoreFinal,0)*3) / 6")
                },
                constraints: table =>
                {
